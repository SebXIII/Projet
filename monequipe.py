...
team1.add_player(SoccerPlayer("Dyrus",Fonceur()))

team4=SoccerTeam("Fnatic 2v2")
team4.add_player(SoccerPlayer("Reignover",DefMove()))
...
team3.add_player(SoccerPlayer("Fox",Attaquant()))
...
team5.add_player(SoccerPlayer("Vizicsacsi",Defonceur()))
team5.add_player(SoccerPlayer("Kikis",DefMove()))
