...
team1.add_player(SoccerPlayer("t1j1",Fonceur()))
...
team4.add_player(SoccerPlayer("t1j1",VideS()))
team4.add_player(SoccerPlayer("t1j2",VideS()))
...
team3.add_player(SoccerPlayer("t1j3",Fonceur()))
